...
<head>
    <meta charset="UTF-8">
    <title>Admin Login - AVUSCRIPT</title>
    ...
    <style>
        ...
        @media (max-width: 768px) {
            ...
            .admin-login-section { padding: 40px 0; }
            .admin-login-card { padding: 30px 25px; margin: 0 15px; }
        ...
        @media (max-width: 480px) {
            ...
            .admin-login-title { font-size: 1.8rem; }
        }
    </style>
</head>
        ...
        <div class="container-main">
            ...
            <div class="collapse navbar-collapse" id="navMain">
                <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item"><a class="nav-link" href="${pageContext.request.contextPath}/arca">ARCA</a></li>
                </ul>
        ...
        <div class="admin-login-container">
            <div class="admin-login-card">
                <div class="admin-login-header">
                    ...
                    <p class="admin-login-subtitle">Restricted access - Authorized personnel only</p>
                </div>
                ...
                <form action="${pageContext.request.contextPath}/login" method="post">
                    ...
                    <div class="form-group">
                        <label for="username" class="form-label">
                            <i class="fas fa-user-cog me-2"></i>Admin Username
                        </label>
                ...
                <div class="security-notice">
                    ...
                    <p>This area is restricted to authorized administrators only. Unauthorized access is prohibited.</p>
                </div>
